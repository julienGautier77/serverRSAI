...
if __name__ =='__main__':
    ...
    mot5=TILTMOTORGUI( IPLat="10.0.6.31", NoMotorLat=1,IPVert="10.0.6.31", NoMotorVert=2,nomWin='Tilt Turning Haut',nomTilt='tilt TB',background='')
    mot5.show()
    mot5.startThread2()
    appli.exec()
